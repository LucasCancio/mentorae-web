...
export function PublicLayout() {
  return (
    <div className="min-h-screen flex flex-col-reverse md:grid md:grid-cols-[3fr_4fr] antialiased">
      ...
      <div className="relative max-h-full flex justify-between rounded-lg border-foreground/5 bg-primary text-muted-foreground border-background m-8 box-border">
